...
int main(int argc, char* argv[])
{
  ...
  string model_folder = "E:\\caffe-windows-ms\\MTCNN_face_detection_alignment-master\\MTCNNv2\\model\\";
  ...
  Mat image = imread("E:\\caffe-windows-ms\\MTCNN_face_detection_alignment-master\\MTCNNv2\\test1.jpg");
